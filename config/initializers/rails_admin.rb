...
# RailsAdmin.config do |config|
  ...
  #      config.main_app_name = ['Gjk', 'Admin']
  # or for a more dynamic name:
  # config.main_app_name = Proc.new { |controller| [Rails.application.engine_name.titleize, controller.params['action'].titleize] }

  # RailsAdmin may need a way to know who the current user is]
  #      config.current_user_method { current_gjk_user } # auto-generated

  # If you want to track changes on your models:
  # config.audit_with :history, 'GjkUser'

  # Or with a PaperTrail: (you need to install it first)
  # config.audit_with :paper_trail, 'GjkUser'
  ...
  # config.excluded_models = ['Event', 'Note']

  # Include specific models (exclude the others):
  # config.included_models = ['Event', 'Note']
